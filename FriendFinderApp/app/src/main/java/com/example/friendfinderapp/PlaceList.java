...
public class PlaceList {
    ...
    public PlaceList(String id, String place_name, String place_owner, String price, String location, String description, String place_picture, String place_open_time, String place_close_time, String contact_person, String category) {
        this.id = id;
